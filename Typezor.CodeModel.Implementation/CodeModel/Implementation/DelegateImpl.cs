...
namespace Typezor.CodeModel.Implementation
{
    public sealed class DelegateImpl : Delegate
    {
        ...
        public static IEnumerable<CodeModel.Delegate> FromMetadata(IEnumerable<IDelegateMetadata> metadata, Item parent)
        {
            return metadata.Select(d => new DelegateImpl(d, parent));
        }
    }
}
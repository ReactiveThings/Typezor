...
namespace Typezor.CodeModel.Implementation
{
    public class DocCommentImpl : DocComment
    {
        ...
        private IEnumerable<CodeModel.ParameterComment> _parameters;
        public override IEnumerable<CodeModel.ParameterComment> Parameters => _parameters ?? (_parameters = ParameterCommentImpl.FromXElements(_root.Elements("param"), this));
    ...
    public class ParameterCommentImpl : ParameterComment
    {
        ...
        public static IEnumerable<CodeModel.ParameterComment> FromXElements(IEnumerable<XElement> elements, Item parent)
        {
           return elements.Select(e => new ParameterCommentImpl(e, parent));
        }
    }
}
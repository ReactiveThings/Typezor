...
namespace Typezor.CodeModel.Implementation
{
    public sealed class FieldImpl : Field
    {
        ...
        public override bool IsReadonly => (_metadata as IClassFieldMetadata)?.IsReadOnly ?? false;
        ...
        public static IEnumerable<CodeModel.Field> FromMetadata(IEnumerable<IFieldMetadata> metadata, Item parent)
        {
            return metadata.Select(f => new FieldImpl(f, parent));
        }
    }
}